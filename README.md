...
Inoltre, vengono presi in considerazione soltanto i pixels con un alpha > 128. L'alpha è l'unità di misura della trasparenza (**A**l'ha**R**ed**G**reen**B**lue) e chiaramente i pixel completamente trasparenti o opachi non possono contribuire alla media del colore intermedio e renderebbero il colore finale poco fedele, per questo vengono eliminati.
